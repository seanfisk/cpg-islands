...
mammalian genes \autocite{pmid11891299}. Methylation of promoter CGIs
...
Presenter First \autocite{Alles:2006:PFO:1155439.1155482} has proven to
...
expected CpG ratio of at least 0.65 \autocite{pmid11891299}. These
...
is \textquote[\cite{pmid17038168}]{based on the physical distance
  between neighboring CpGs on the chromosome}. \autocite{pmid19232104}
...
\autocite{behnel2010cython}, a language which is able to generate
...
programming language \autocite{pmid19304878}. Biopython is especially
