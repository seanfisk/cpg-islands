...
\fref{fig:tj-control-flow}. If the complexity of this algorithm is
...
too difficult to test. \textit{Full disclosure: Our accumulating
  ...
  cyclomatic complexity of 8. We do have the opinion that our code is
  somewhat cleaner, and the fact that it is tested.}
